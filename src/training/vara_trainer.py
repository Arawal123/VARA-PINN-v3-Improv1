...
class VARATrainer(ExperimentTrainer):
    ...
    def _build_local_decision(
        ...
        return {
            ...
            "u_centerline_rmse_before": metrics_before.get("u_centerline_rmse"),
            "u_centerline_rmse_after": metrics_after.get("u_centerline_rmse"),
            "v_centerline_rmse_before": metrics_before.get("v_centerline_rmse"),
            "v_centerline_rmse_after": metrics_after.get("v_centerline_rmse"),
            "centerline_profile_score_before": metrics_before.get("centerline_profile_score"),
            "centerline_profile_score_after": metrics_after.get("centerline_profile_score"),
            "cavity_benchmark_score_before": metrics_before.get("cavity_benchmark_score"),
            "cavity_benchmark_score_after": metrics_after.get("cavity_benchmark_score"),
            **decision_metrics,
        }
    ...
    def _flat_local_decision(self, decision: dict[str, Any]) -> dict[str, Any]:
        return {
            ...
            "u_centerline_rmse_before": decision.get("u_centerline_rmse_before"),
            "u_centerline_rmse_after": decision.get("u_centerline_rmse_after"),
            "v_centerline_rmse_before": decision.get("v_centerline_rmse_before"),
            "v_centerline_rmse_after": decision.get("v_centerline_rmse_after"),
            "centerline_profile_score_before": decision.get("centerline_profile_score_before"),
            "centerline_profile_score_after": decision.get("centerline_profile_score_after"),
            "cavity_benchmark_score_before": decision.get("cavity_benchmark_score_before"),
            "cavity_benchmark_score_after": decision.get("cavity_benchmark_score_after"),
